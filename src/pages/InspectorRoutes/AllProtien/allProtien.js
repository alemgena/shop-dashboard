...
import AllProtien from '../../posts/ranchMangment/request/InspectorRequest/AllProtien'
...
const ManageRanch = (props) => {
  ...
  const { viewAllProteins, deleteRanch } = AllProtien()
