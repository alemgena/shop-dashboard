...
import OneRanch from './OneRanch'
import AllRanchRequest from '../posts/ranchMangment/request/InspectorRequest/AllRanchRequest'
...
import { AllRanchPage } from './AllRanchPage'
import RanchDetail from './AllVaccien/raanchLiveStock'
const headCells = [
  { id: 'name', label: 'Name' },
  { id: 'area', label: 'Area' },
...
const ManageRanch = (props) => {
  ...
  const { viewAllRanch, deleteRanch } = AllRanchRequest()
...
setRanchOpen(true);
  ...
  return (
    <OftadehLayout>
      ...
      <TableCell>{item.type==='Remote Ranch'&&
       <Controls.ActionButton
                        color="primary"
                        title="View Total Ranch LiveStocks"
                        variant="contained"
                        onClick={() => {
                          openRanchLiveStock(item.id)
                        }}
                      >
