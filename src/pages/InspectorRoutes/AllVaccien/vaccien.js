...
import AllVaccien from '../../posts/ranchMangment/request/InspectorRequest/AllVaccien'
...
import VaccienDetial from './VaccienDetail'
/*
ExpirationDate: "2/5/2022"
createdAt: "2022-04-04T09:40:47.000Z"
deliveryStatus: "sent"
discription: "hfgvghbhj"
dosage: "5"
id: "21353eb4-344d-4edb-8c6a-015bee995d6c"
name: "rrrrrrrr"
productionDate: "2/5/2022"
quantity: "1"
ranchId: "b5a4a8d0-75a4-4e9d-889c-1a46ccf9b1e4"
ranchname: "ranch1234"
*/
const headCells = [
  { id: 'name', label: 'Name' },
...
const ManageRanch = (props) => {
  ...
  const { viewAllVaccien, deleteRanch } = AllVaccien()
  ...
  const[ranchId,setRanch]=useState()
