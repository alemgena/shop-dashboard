...
const RanchManagerForm = ({
  ...
  const { addRanchManager, updateRanch } = RanchManagerApiRequests()
  ...
  const handleSubmit = (e) => {
    ...
    if (validate()) {
      ...
      if (values.editing === false) {
        console.log(values.ranch.name)
        addRanchManager(values, values.ranch.name).then((data) => {
          console.log(data)
          if (data.err) {
